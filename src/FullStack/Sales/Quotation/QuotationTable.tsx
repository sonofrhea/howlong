        ...
        <div className="overflow-hidden">
                        ...
                        {quotations.map((quotation: QuotationList) => {
                            ...
                            return (
                                ...
                                onClick={() => onQuotationClick(quotationId)}>
                                    ...
                                    {/* Valid Until */}
                                    <td className="px-2 py-2 truncate">
                                        <div className="text-sm text-black truncate">{quotation.valid_until}</div>
                                    </td>

                                    {/* Customer */}
                                    <td className="px-2 py-2 truncate">
                                        <div className="text-sm text-black truncate">{quotation.customer}</div>
                                    </td>
            ...
            <div className="px-4 py-3 bg-gray-50 border-t border-gray-200">
                <div className="flex items-center justify-between text-sm text-gray-600">
                    <div>
                        Showing {((currentPage - 1) * itemsPerPage) + 1} to {Math.min(currentPage * itemsPerPage, totalItems)} of {totalItems} quotations
                    </div>
                    <div className="flex items-center gap-2">
