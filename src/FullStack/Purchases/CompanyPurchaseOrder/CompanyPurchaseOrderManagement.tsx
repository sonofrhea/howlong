...
import { fetchCompanyPurchaseOrders, createCompanyPurchaseOrder, fetchCompanyPurchaseOrderById, 
  updateCompanyPurchaseOrder, deleteCompanyPurchaseOrder
} from "../Engines";
...
import { fetchCompanyPurchaseInvoices } from "../../Purchases/Engines";
...
function CompanyPurchaseOrderManagement() {
    ...
    const { data: CompanyPurchaseOrders = [], isLoading: isLoadingCompanyPurchaseOrders, error: CompanyPurchaseOrderError} = useQuery({
        queryKey: ['CompanyPurchaseOrders'],
        queryFn: fetchCompanyPurchaseOrders
    });
    ...
    const { data: selectedCompanyPurchaseOrder, isLoading: isLoadingCompanyPurchaseOrder } = useQuery({
        queryKey: ['companyPurchaseOrder', selectedCompanyPurchaseOrderId],
        queryFn: () => fetchCompanyPurchaseOrderById(selectedCompanyPurchaseOrderId!),
        enabled: !!selectedCompanyPurchaseOrderId,
    });
    // ------------------------------------------------------------------------------------
                    // MANIPULATIONS
    ...
    const sortedCompanyPurchaseOrders = React.useMemo(() => {
        if (!sortConfig.key) return filteredCompanyPurchaseOrders;

        return [...filteredCompanyPurchaseOrders].sort((a, b) => {
    ...
    }, [filteredCompanyPurchaseOrders, sortConfig]);
    ...
    // Pagination calculations for Company purchase order Table
    const totalCompanyPurchaseOrderPages = Math.ceil(sortedCompanyPurchaseOrders.length / itemsPerPage);
    const startIndex = (currentPage - 1) * itemsPerPage;
    const paginatedCompanyPurchaseOrders = sortedCompanyPurchaseOrders.slice(startIndex, startIndex + itemsPerPage);
    ...
    if (isLoadingCompanyPurchaseOrders) return (
        ...
        <div className="text-center">
            ...
            <p className="mt-4 text-gray-600">Loading company purchase orders...</p>
        </div>
        </div>
    );
    ...
    if (CompanyPurchaseOrderError) return (
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 max-w-md text-center">
            ...
            <p className="text-gray-600">Failed to load company purchase orders. Please try again.</p>
        </div>
        </div>
    );
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Company Purchase Order Management</p>
                        </div>
                    </div>
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex items-start justify-between mb-8">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                        <h1 className="text-4xl font-light text-gray-900 tracking-tight">Company Purchase Orders</h1>
                        <p className="text-gray-500 mt-2">Manage and track your purchase order transactions</p>
                        </div>
                    </div>
                    </div>
                    ...
                    {(view === 'form' || view === 'details' || view === 'edit') && (
                        <button
                        onClick={handleBackToCompanyPurchaseOrdersList}
                ...
                <div className="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
                    <CompanyPurchaseOrderTable 
                    companyPurchaseOrders={paginatedCompanyPurchaseOrders}
                    onCompanyPurchaseOrderClick={handleCompanyPurchaseOrderClick}
                    onEditCompanyPurchaseOrder={handleEditCompanyPurchaseOrder}
                    onDeleteCompanyPurchaseOrder={handleDeleteCompanyPurchaseOrder}
                    sortConfig={sortConfig}
                    onSort={handleSort}
                    currentPage={currentPage}
                    totalPages={totalCompanyPurchaseOrderPages}
                    totalItems={sortedCompanyPurchaseOrders.length}
                ...
                <div className="w-[100%] bg-gray-50 rounded-2xl shadow-sm border border-gray-200">
                    ...
                    <div className="flex items-center gap-4 mb-8 justify-between">
                        ...
                        <div>
                        <h2 className="text-2xl font-light text-gray-900">Create Purchase Order</h2>
                    ...
                    <CompanyPurchaseOrderForm 
                        onSubmit={handleAddCompanyPurchaseOrder} 
                        isSubmitting={createCompanyPurchaseOrderMutation.isPending} 
                    ...
                    />
                    {createCompanyPurchaseOrderMutation.isError && (
                ...
                {view === 'edit' && selectedCompanyPurchaseOrder && (
                <CompanyPurchaseOrderEdit 
                    companyPurchaseOrder={selectedCompanyPurchaseOrder}
...
export default CompanyPurchaseOrderManagement;
