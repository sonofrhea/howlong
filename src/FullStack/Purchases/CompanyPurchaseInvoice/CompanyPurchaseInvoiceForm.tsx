...
import { CompanyPurchaseInvoiceFormProps, CompanyPurchaseInvoiceInputs } from "../constants/Types";
...
const CompanyPurchaseInvoiceForm: React.FC<CompanyPurchaseInvoiceFormProps> = ({
    onSubmit,
    isSubmitting,
    onCancel, 
    agents,
