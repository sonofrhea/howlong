...
const CompanyPurchaseInvoiceTable: React.FC<CompanyPurchaseInvoiceTableProps> = ({
    ...
    if (companyPurchaseInvoices.length === 0) {
        return (
            <div className="text-center py-12">
                ...
                <h3 className="text-lg font-semibold text-gray-600 mb-2">No purchase invoice found</h3>
                <p className="text-gray-500">Get started by creating your first purchase invoice.</p>
            </div>
        );
    }
                                    ...
                                    <td className="px-2 py-2">
                                        <div className="flex items-center justify-center gap-1">
                                            <button 
                                                ...
                                                onClick={(e) => {
                                                    e.stopPropagation();
                                                    onEditCompanyPurchaseInvoice(companyPurchaseInvoiceId, companyPurchaseInvoice);
                                                }}
 ...
 export default CompanyPurchaseInvoiceTable;
