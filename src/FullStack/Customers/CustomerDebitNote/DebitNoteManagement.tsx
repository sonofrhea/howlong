...
// ------------------------------------------------------------------------------------
  ...
  const handleAddDebitNote = async (debitNoteData) => {

    const customer = customers.find(c => String(c.customer_number) === String(debitNoteData.customer));
    const currency = currencies.find(c => String(c.currency_symbol) === String(debitNoteData.currency));
    const agent = agents.find(a => String(a.username) === String(debitNoteData.agent));
    ...
    const apiData = {
      ...
      debit_note_header: (debitNoteData.debit_note_header || []).map(item => {
        ...
        return {
          ...
          description: item.description || debitNoteData.description,
    ...
    if (hasFile(apiData)) {
      ...
      createDebitNoteMutation.mutate(fd);
    } else {
      createDebitNoteMutation.mutate(apiData);
    }
  };
  ...
  const handleUpdateDebitNote = (debitNoteData) => {
...
// ------------------------------------------------------------------------------------
  ...
  const handleDebitNoteClick = (debitNoteId) => {
...
// ------------------------------------------------------------------------------------
  ...
  const handleEditDebitNote = (debitNoteId, debitNoteData) => {
    setSelectedDebitNoteId(debitNoteId);
    setView('edit');
  };
// ------------------------------------------------------------------------------------
        ...
        <div className="max-w-7xl mx-auto">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-light text-gray-900">
                      {new Set(debitNotes.map(c => c.currency?.currency_code)).size}
                    </div>
          ...
          {view === 'list' && (
            <div className="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
              <DebitNoteTable 
                ...
                totalDebitNotePages={totalDebitNotePages}
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-white border border-gray-100 rounded-2xl shadow-sm p-8">
                ...
                <DebitNoteForm 
                  ...
                  isSubmitting={createDebitNoteMutation.isLoading} 
          ...
          {view === 'edit' && selectedDebitNote && (
            <DebitNoteEdit 
              ...
              isSubmitting={updateDebitNoteMutation.isLoading}
              onBack={handleBackToDebitNotesList}
              onCancel={handleBackToDebitNotesList}
            />
          )}
