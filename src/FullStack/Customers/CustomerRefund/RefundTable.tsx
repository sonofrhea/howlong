    ...
    if (refunds.length === 0) {
        ...
        return (
            <div className="text-center py-12">
                ...
                <h3 className="text-lg font-semibold text-gray-600 mb-2">No refund found</h3>
                <p className="text-gray-500">Get started by creating your first refund.</p>
            </div>
        );
    }
                                    ...
                                    <td className="px-2 py-2">
                                        <div className="flex items-center justify-center gap-1">
                                            ...
                                            <button 
                                                ...
                                                onClick={(e) => {
                                                    e.stopPropagation();
                                                    if (window.confirm(`Are you sure you want to delete ${refund.refund_number}?`)) {
