...
export const forms = {
  ...
  select: {
    ...
    partial2: "w-[80%] text-black drop-shadow-md shadow-inner rounded cursor-pointer border border-violet-300 px-3 py-2 focus:ring-2 focus:ring-green-300",
...
export const buttons = {
  ...
  secondary: "px-6 py-3 bg-yellow-800 cursor-pointer text-white rounded drop-shadow-md shadow-xl hover:bg-red-700 font-medium disabled:opacity-50",
