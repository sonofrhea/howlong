...
function CashBookManagement() {
    ...
    const handleUpdateCashBook = (cashBookData: CashBookInputs) => {
    ...
    if (isLoadingCashBooks) return (
        ...
        <div className="text-center">
            ...
            <p className="mt-4 text-gray-600">fetching cash books...</p>
        </div>
        </div>
    );
        ...
        <div className="p-8">
            ...
            {view === 'form' && (
                ...
                <div className="bg-white border border-gray-100 rounded-2xl shadow-sm p-8">
                    ...
                    isSubmitting={createCashBookMutation.isPending} 
