...
function ReceiptVoucherManagement() {
    const queryClient = useQueryClient();
    const [view, setView] = useState('list');
    const [searchTerm, setSearchTerm] = useState("");
    const [selectedReceiptVoucherId, setSelectedReceiptVoucherId] = useState(null);
    // ------------------------------------------------------------------------------------
    ...
    const { data: receiptVouchers = [], isLoading: isLoadingReceiptVouchers, error: receiptVouchersError} = useQuery({
        queryKey: ['receiptVouchers'],
        queryFn: fetchReceiptVouchers
    });
    ...
    const { data: selectedReceiptVoucher, isLoading: isLoadingReceiptVoucher } = useQuery({
        queryKey: ['receiptVoucher', selectedReceiptVoucherId],
        queryFn: () => fetchReceiptVoucherById(selectedReceiptVoucherId),
        enabled: !!selectedReceiptVoucherId,
    });
    // ------------------------------------------------------------------------------------
                    // MANIPULATIONS
    ...
    const handleAddReceiptVoucher = async (receiptVoucherData) => {
    ...
    const handleUpdateReceiptVoucher = (receiptVoucherData) => {
    ...
    const handleDeleteReceiptVoucher = async (receiptVoucherId) => {
    ...
    const handleReceiptVoucherClick = (receiptVoucherId) => {
    ...
    const handleEditReceiptVoucher = (receiptVoucherId, receiptVoucherData) => {
        setSelectedReceiptVoucherId(receiptVoucherId);
        setView('edit');
    };
    // ------------------------------------------------------------------------------------

    const handleBackToReceiptVouchersList = () => {
        setView('list');
    ...
    const filteredReceiptVouchers = receiptVouchers.filter(receiptVoucher => {
        const receiptNumber = receiptVoucher.reference_number?.toLowerCase() || '';
    ...
    const sortedReceiptVouchers = React.useMemo(() => {
        if (!sortConfig.key) return filteredReceiptVouchers;

        return [...filteredReceiptVouchers].sort((a, b) => {
    ...
    }, [filteredReceiptVouchers, sortConfig]);
    ...
    // Pagination calculations for Receipt Voucher
    const totalReceiptVouchers = Math.ceil(sortedReceiptVouchers.length / itemsPerPage);
    const startIndex = (currentPage - 1) * itemsPerPage;
    const paginatedReceiptVouchers = sortedReceiptVouchers.slice(startIndex, startIndex + itemsPerPage);
    ...
    if (isLoadingReceiptVouchers) return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
        <div className="text-center">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600 mx-auto"></div>
            <p className="mt-4 text-gray-600">Loading receipt vouchers...</p>
        </div>
        </div>
    );

    if (receiptVouchersError) return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
        <div className="bg-white rounded-xl shadow-lg p-8 max-w-md text-center">
            ...
            <p className="text-gray-600">Failed to load receipt vouchers. Please try again.</p>
        </div>
        </div>
    );
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Receipt Voucher Management</p>
                        </div>
                    </div>
        ...
        <div className="p-8">
            ...
            <div className="mb-12">
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        <h1 className="text-4xl font-light text-gray-900 tracking-tight">Receipt Vouchers</h1>
                        <p className="text-gray-500 mt-2">Manage and track your receipt vouchers</p>
                    </div>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        onClick={handleBackToReceiptVouchersList}
                ...
                <div className="flex items-center gap-6">
                    <div className="flex items-center gap-4">
                    <div className="text-center">
                        <div className="text-2xl font-light text-gray-900">{receiptVouchers.length}</div>
                        <div className="text-sm text-gray-500">Total Receipt Vouchers</div>
                    </div>
                    <div className="w-px h-8 bg-gray-200"></div>
                    <div className="text-center">
                        <div className="text-2xl font-light text-gray-900">
                        {new Set(receiptVouchers.map(c => c.currency?.currency_code)).size}
                        </div>
            ...
            {view === 'list' && (
                ...
                <ReceiptVoucherTable 
                    receiptVouchers={paginatedReceiptVouchers}
                    onReceiptVoucherClick={handleReceiptVoucherClick}
                    onEditReceiptVoucher={handleEditReceiptVoucher}
                    onDeleteReceiptVoucher={handleDeleteReceiptVoucher}
                    sortConfig={sortConfig}
                    onSort={handleSort}
                    currentPage={currentPage}
                    totalReceiptVouchers={totalReceiptVouchers}
                    totalItems={sortedReceiptVouchers.length}
            ...
            {view === 'form' && (
                ...
                <div className="bg-white border border-gray-100 rounded-2xl shadow-sm p-8">
                    ...
                    <div>
                        <h2 className="text-2xl font-light text-gray-900">Create Receipt Voucher</h2>
                        <p className="text-gray-500">Add a new receipt voucher to your records</p>
                    </div>
                    </div>
                    <ReceiptVoucherForm 
                    onSubmit={handleAddReceiptVoucher} 
                    isSubmitting={createReceiptVoucherMutation.isLoading} 
            ...
            {view === 'edit' && selectedReceiptVoucher && (
                <ReceiptVoucherEdit 
                receiptVoucher={selectedReceiptVoucher}
                onSubmit={handleUpdateReceiptVoucher}
                isSubmitting={updateReceiptVoucherMutation.isLoading}
                onBack={handleBackToReceiptVouchersList}
                onCancel={handleBackToReceiptVouchersList}
                />
            )}
