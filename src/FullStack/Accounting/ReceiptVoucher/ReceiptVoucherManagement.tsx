...
function ReceiptVoucherManagement() {
    ...
    const selectedReceiptVoucherId = searchParams.get('reference_number') ? Number(searchParams.get('reference_number')) : null;
    // ------------------------------------------------------------------------------------
    ...
    const updateReceiptVoucherMutation = useMutation({
        ...
        onSuccess: () => {
            ...
            navigateToView('details', selectedReceiptVoucherId!);
        },
        onError: (error: any) => {
    ...
    const handleReceiptVoucherClick = (receiptVoucherId: number) => {
        navigateToView('details', receiptVoucherId);
    };
    // ------------------------------------------------------------------------------------


    const handleEditReceiptVoucher = (receiptVoucherId: number) => {
        navigateToView('edit', receiptVoucherId);
    };
    // ------------------------------------------------------------------------------------
        ...
        <div className="p-8">
            ...
            <div className="mb-12">
                ...
                <div className="flex items-center gap-6 justify-between">
                    ...
                    <div className="text-center">
                        ...
                        {new Set(receiptVouchers.map((c: any) => c.currency?.currency_code)).size}
                        </div>
            ...
            {view === 'list' && (
                ...
                <ReceiptVoucherTable 
                    ...
                    totalPages={totalReceiptVouchers}
            ...
            {view === 'form' && (
                ...
                <div className="bg-white border border-gray-100 rounded-2xl shadow-sm p-8">
                    ...
                    isSubmitting={createReceiptVoucherMutation.isPending} 
