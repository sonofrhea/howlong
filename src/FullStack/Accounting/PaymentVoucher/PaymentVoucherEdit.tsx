...
import { PaymentVoucherInputs, PaymentVoucherProps } from "../Constants/Types";
...
const PaymentVoucherEdit: React.FC<PaymentVoucherProps> = ({
    paymentVoucher,
    onSubmit,
    isSubmitting,
    onCancel,
