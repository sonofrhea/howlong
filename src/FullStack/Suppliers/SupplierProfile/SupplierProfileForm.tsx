...
import { SupplierCategoryResponse, SupplierProfileFormProps, SupplierProfileInputs } from "../constants/Types";
...
const currencyChange = currencyHandler(currencies, setValue);
    ...
    return(
        <div>
            <title>Form | Suppliers · Urusentra ERP for Small & Medium Enterprises</title>
            <meta name="create" content="Urusentra suppliers profile create – modern ERP for SMEs" />
                ...
                <div className="p-6 space-y-8 ">
                    ...
                    <div className="bg-orange-50 rounded-lg p-6 border border-orange-200">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <div>
                                <div className="text-sm text-black mb-1">Preferred Currency</div>
