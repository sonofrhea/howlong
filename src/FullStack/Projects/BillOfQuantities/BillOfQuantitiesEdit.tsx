...
import { BillOfQuantitiesInputs, BillOfQuantitiesProps, ProjectProfileResponse } from '../constants/Types';
...
const BillOfQuantitiesEdit: React.FC<BillOfQuantitiesProps> = ({
    billOfQuantity,
    onSubmit,
    isSubmitting,
    onCancel,
