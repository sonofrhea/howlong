...
function BillOfQuantitiesManagement() {
    ...
    const [selectedBillOfQuantityId, setSelectedBillOfQuantityId] = useState(null);
    // ------------------------------------------------------------------------------------
    ...
    const handleAddBillOfQuantity = async (billOfQuantitiesData) => {

        const customer = customers.find(c => String(c.customer_number) === String(billOfQuantitiesData.customer));
        const currency = currencies.find(c => String(c.currency_symbol) === String(billOfQuantitiesData.currency));
        const agent = agents.find(a => String(a.username) === String(billOfQuantitiesData.agent));
        ...
        const apiData = {
        date: billOfQuantitiesData.date,
        customer: {
        ...
        credit_note_header: (billOfQuantitiesData.credit_note_header || []).map(item => {
            ...
            description: item.description || billOfQuantitiesData.description,
        ...
        createBillOfQuantityMutation.mutate(fd);
        } else {
        createBillOfQuantityMutation.mutate(apiData);
        }
    };
    ...
    const handleUpdateBillOfQuantity = (billOfQuantitiesData) => {
    ...
    const handleDeleteBillOfQuantity = async (billOfQuantityId) => {
    ...
    const handleBillOfQuantityClick = (billOfQuantityId) => {
    ...
    const handleEditBillOfQuantity = (billOfQuantityId, billOfQuantitiesData) => {
        setSelectedBillOfQuantityId(billOfQuantityId);
        setView('edit');
    };
    // ------------------------------------------------------------------------------------
    ...
    const filteredBillOfQuantities = billOfQuantities.filter(billOfQuantity =>
    ...
    if (isLoadingBillOfQuantities) return (
        ...
        <div className="text-center">
            ...
            <p className="mt-4 text-gray-600">Loading Bill Of Quantities...</p>
        </div>
        </div>
    );
        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="max-w-7xl mx-auto">
                ...
                {view === 'list' && (
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="text-2xl font-light text-gray-900">
                            {new Set(billOfQuantities.map(c => c.currency?.currency_code)).size}
                        </div>
                ...
                <div className="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
                    ...
                    totalBillOfQuantitiesPages={totalBillOfQuantitiesPages}
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <BillOfQuantitiesForm 
                        ...
                        isSubmitting={createBillOfQuantityMutation.isLoading} 
                ...
                <BillOfQuantitiesEdit 
                    ...
                    isSubmitting={updateBillOfQuantityMutation.isLoading}
                    onBack={handleBackToBillOfQuantitiesList}
                    onCancel={handleBackToBillOfQuantitiesList}
                />
                )}
