...
import { ProjectProfileInputs, ProjectProfileProps } from "../constants/Types";
...
const ProjectsProfileEdit: React.FC<ProjectProfileProps> = ({
    project,
    onSubmit,
    isSubmitting,
    onCancel,
...
export default ProjectsProfileEdit;