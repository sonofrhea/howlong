...
const JobCostLedgerDetails: React.FC<JobCostLedgerDetailsProps> = ({
    ...
    return (
        <div className="w-full bg-gray-50 shadow-gray-100 rounded-xl shadow-2xl border border-gray-200">
                <div className="px-6 py-4 m-3 border-b border-gray-200 rounded-lg shadow-sm flex items-center justify-between">
                ...
                <div className="bg-white m-3 rounded-xl shadow-md p-6 md:p-8 mb-6">
                    <div className="flex-1">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className={`px-3 py-0 rounded-full text-sm font-medium ${
                ...
                <div className="bg-blue-50 m-3 rounded-xl shadow-md border-2 border-blue-200 p-6 mb-6">
                ...
                {/* <!-- Cost Summary Cards --> */}
                <div className="grid grid-cols-1 m-3 md:grid-cols-2 gap-4 mb-6">
                    ...
                    <div className="bg-white rounded-xl shadow-md border border-slate-200 p-6">
                        ...
                        <div className="text-2xl text-left font-bold">{jobCostLedger.net_variance}</div>
                        <div className="text-xs text-left text-slate-500 mt-1">ACTUAL COST minus BOQ ESTIMATION</div>
                    </div>
                </div>

                <div className="bg-white m-3 rounded-xl shadow-md border border-slate-200 overflow-hidden">
                ...
                {/* <!-- Metadata Footer --> */}
                <div className="mt-6 m-3 bg-white rounded-xl shadow-md border border-slate-200 p-6">
