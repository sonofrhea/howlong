...
function JobCostLedgerManagement() {
    ...
    const { data: jobCostCodes = [] } = useQuery({
        queryKey: ['jobCostCodes'],
        queryFn: fetchJobCostCodes
    });
    ...
    const filteredJobCostLedgers = jobCostLedgers.filter((jobCostLedger: any) =>
        String(jobCostLedger.job_cost_number)?.toLowerCase().includes(searchTerm.toLocaleLowerCase()) ||
        jobCostLedger.date?.toLowerCase().includes(searchTerm.toLocaleLowerCase())
    );
    ...
    if (isLoadingJobCostLedgers) return (
        ...
        <div className="text-center">
            ...
            <p className="mt-4 text-gray-600">fetching Job cost ledgers...</p>
        </div>
        </div>
    );
        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="max-w-7xl mx-auto">
                ...
                {view === 'list' && (
                    <div className="flex items-center gap-6 justify-between">
                        ...
                        <div className="flex gap-4">
                            ...
                            <input
                                type="text"
                                placeholder="Search job cost ledgers..."
                                value={searchTerm}
                ...
                <div className="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
                    ...
                    totalPages={totalJobCostLedgerPages}
                ...
                <div className="w-full bg-gray-50 rounded-2xl shadow-sm border border-gray-200">
                    ...
                    <JobCostLedgerForm 
                        ...
                        isSubmitting={createJobCostLedgerMutation.isPending} 
