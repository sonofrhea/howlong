          ...
          <div className="max-w-4xl mx-auto mb-9 flex items-end justify-between gap-4 flex-wrap">
            ...
            <div className="flex gap-2 items-center flex-wrap">
              ...
              <button onClick={onEdit}
                className="inline-flex items-center gap-2 bg-[#0a0a0a] text-white text-[0.75rem] font-bold tracking-widest uppercase px-5 py-2.5 rounded-lg shadow-sm hover:bg-gray-800 hover:-translate-y-px active:translate-y-0 transition-all cursor-pointer border-0">
