...
import { fetchCurrencies } from "../Engines";
...
// ------------------------------------------------------------------------------------
    ...
    // Pagination calculations for Currencies
    
    const totalCurrenciesPages = Math.ceil(currencies.length / itemsPerPage);
...
// ------------------------------------------------------------------------------------
    ...
    if (isLoadingCurrencies) return(
        <div className="min-h-screen bg-white flex items-center justify-center">
            <div className="w-64">
                <div>fetching currencies...</div>
                <span className={spinningStyles.terminalBar.spinner}></span>
            </div>
        </div>
    );

    if (currenciesError) return(
        <div className="min-h-screen bg-linear-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
            <div className="bg-white rounded-xl shadow-lg p-8 max-w-md text-center">
                ...
                <p className="text-gray-600">Failed to load currencies. Please try again.</p>
            </div>
        </div>
    );
        ...
        <div className="min-h-screen bg-[#f0f2f7]">
            ...
            {view === 'list' && (
                <CurrenciesTable
                    ...
                    totalPages={totalCurrenciesPages}
