    ...
    return(
        <div className="bg-white">
            ...
            <div className="flex bg-white" style={{ fontFamily: 'Montserrat, system-ui' }}>
                ...
                <Link 
                    to="/customers"
                    className="fixed top-4 right-4 z-50 group flex items-center gap-3 px-3 py-1 bg-white border-gray-200 rounded-2xl text-sm font-semibold text-gray-600 shadow-sm border-2 transition-all duration-300 hover:text-blue-600 hover:shadow-md hover:-translate-y-0.5"
